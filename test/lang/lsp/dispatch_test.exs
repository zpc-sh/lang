defmodule Lang.LSP.DispatchTest do
  ...
  test "parser.detect_format infers markdown from content" do
    msg = %{
      "id" => 1,
      "method" => "lang.parser.detect_format",
  ...
  test "parser.parse handles JSON" do
    msg = %{
      "id" => 2,
      "method" => "lang.parser.parse",
      "params" => %{"content" => ~s({"a":1}), "format" => "json"}
    }
  ...
  test "fs.preview returns joined content for an existing file" do
    ...
    msg = %{
      ...
      "params" => %{"path" => "README.md", "max_lines" => 5}
    }
  ...
  test "analysis.document returns analysis structure" do
    msg = %{
      "id" => 4,
      "method" => "lang.analyze.document",
      "params" => %{"content" => "defmodule X do\nend", "format" => "elixir"}
    }
  ...
  test "storage CRUD via in-memory store" do
    create = %{
      "id" => 5,
      "method" => "lang.storage.create_session",
    ...
    close = %{
      "id" => 7,
      "method" => "lang.storage.close_session",
