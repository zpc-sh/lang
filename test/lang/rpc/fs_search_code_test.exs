defmodule Lang.RPC.FsSearchCodeTest do
  ...
  setup do
    root = Path.join(System.tmp_dir!(), "fs_search_code_" <> Integer.to_string(:erlang.unique_integer([:positive])))
    File.mkdir_p!(root)
  ...
  test "lang.fs.search_code finds function in js", %{root: root} do
    ...
    {:ok, %{matches: matches}} =
      Router.dispatch(%{}, "lang.fs.search_code", %{"root_path" => root, "language" => "javascript", "pattern" => patt, "max_results" => 10})
