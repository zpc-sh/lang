...
- Spec-driven testing pattern (`*_spec.mbt` + `*_spec_test.mbt`) is implemented in `mulsp`, `cave`, and `codex`; it is designed as a recursive, self-documenting, self-replicating pattern across partitions
