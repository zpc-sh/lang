defmodule LangWeb.Router do
  ...
  pipeline :browser do
    ...
    plug LangWeb.Plugs.SentryUserContextPlug
  end
  ...
  pipeline :browser_json do
    ...
    plug LangWeb.Plugs.AuthPlug, :load_from_session
    plug LangWeb.Plugs.SentryUserContextPlug
    plug LangWeb.Plugs.SentryParamsRedactionPlug
  end
  ...
  # Admin-only metrics exposition
  scope "/metrics", LangWeb do
    pipe_through [:browser_json_admin, :prometheus_enabled]
    get "/providers", MetricsController, :providers
    get "/", MetricsController, :index
  end

  pipeline :prometheus_enabled do
    plug LangWeb.Plugs.PrometheusEnabledPlug
  end
  ...
  live_session :authenticated,
    ...
    scope "/", LangWeb do
      ...
      live "/lsp/metrics", LspMetricsLive, :index
      ...
      live "/settings/credentials", ProviderCredentialsLive, :index
  ...
  if Application.compile_env(:lang, :dev_routes) do
    ...
    scope "/dev", LangWeb do
      pipe_through :browser
      get "/sentry/boom", DebugController, :sentry_boom
    end

    scope "/api/dev", LangWeb do
      pipe_through :api
      post "/sentry/boom", DebugController, :sentry_boom_json
    end
