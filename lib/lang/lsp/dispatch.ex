defmodule Lang.LSP.Dispatch do
  ...
  def process(%{"method" => method} = msg) do
    case method do
      ...
      # ==== Generative & Media (stubs) ======================================
      "lang.text.generate" -> gen_text(:generate, msg)
      "lang.text.summarize" -> gen_text(:summarize, msg)
      "lang.text.translate" -> gen_text(:translate, msg)
      "lang.text.style_transfer" -> gen_text(:style_transfer, msg)
      "lang.text.rewrite" -> gen_text(:rewrite, msg)
      "lang.image.generate" -> gen_image(:generate, msg)
      "lang.image.variation" -> gen_image(:variation, msg)
      "lang.audio.transcribe" -> gen_audio(:transcribe, msg)
      "lang.audio.synthesize" -> gen_audio(:synthesize, msg)
      "lang.video.transcribe" -> gen_video(:transcribe, msg)
      "lang.video.summarize" -> gen_video(:summarize, msg)
      "lang.media.generate_music" -> gen_media(:generate_music, msg)
      "lang.media.generate_video" -> gen_media(:generate_video, msg)
      "lang.media.storyboard" -> gen_media(:storyboard, msg)
      "lang.media.caption_video" -> gen_media(:caption_video, msg)
      "lang.media.mix_tracks" -> gen_media(:mix_tracks, msg)

      # ==== Avici Conversational & Knowledge (stubs) ========================
      "avici.conversation.start" -> avici_conv(:start, msg)
      "avici.conversation.message" -> avici_conv(:message, msg)
      "avici.conversation.set_frame" -> avici_conv(:set_frame, msg)
      "avici.conversation.summary" -> avici_conv(:summary, msg)
      "avici.conversation.context" -> avici_conv(:context, msg)
      "avici.conversation.suggest_topics" -> avici_conv(:suggest_topics, msg)
      "avici.conversation.extract_morsels" -> avici_conv(:extract_morsels, msg)
      "avici.conversation.link_concepts" -> avici_conv(:link_concepts, msg)
      "avici.conversation.set_mode" -> avici_conv(:set_mode, msg)
      "avici.conversation.end" -> avici_conv(:end, msg)
      "avici.session.attach" -> avici_conv(:attach, msg)
      "avici.session.detach" -> avici_conv(:detach, msg)

      "avici.knowledge.morsel.capture" -> avici_knowledge(:morsel_capture, msg)
      "avici.knowledge.morsel.analyze" -> avici_knowledge(:morsel_analyze, msg)
      "avici.knowledge.morsel.batch_ingest" -> avici_knowledge(:morsel_batch_ingest, msg)
      "avici.knowledge.concept.discover" -> avici_knowledge(:concept_discover, msg)
      "avici.knowledge.concept.evolve" -> avici_knowledge(:concept_evolve, msg)
      "avici.knowledge.concept.get" -> avici_knowledge(:concept_get, msg)
      "avici.knowledge.correlation.discover" -> avici_knowledge(:correlation_discover, msg)
      "avici.knowledge.crystallize" -> avici_knowledge(:crystallize, msg)
      "avici.knowledge.cleanup_weak" -> avici_knowledge(:cleanup_weak, msg)

      "avici.search.semantic" -> avici_search(:semantic, msg)
      "avici.search.hybrid" -> avici_search(:hybrid, msg)
      "avici.search.contextual" -> avici_search(:contextual, msg)

      "avici.pipeline.ingest" -> avici_pipeline(:ingest, msg)
      "avici.pipeline.status" -> avici_pipeline(:status, msg)
      "avici.frame.create" -> avici_frame(:create, msg)
      "avici.frame.transition" -> avici_frame(:transition, msg)
      "avici.frame.set_mode" -> avici_frame(:set_mode, msg)
      # KEI-aligned endpoints (LSP wrappers)
      "avici.frame.get" -> avici_frame(:get, msg)
      "avici.services.list" -> avici_services(:list, msg)
      "avici.harvest.start" -> avici_harvest(:start, msg)
      "avici.patterns.create" -> avici_patterns(:create, msg)
      "avici.decisions.create" -> avici_decisions(:create, msg)
      # Crystal domain (aligns with Avici.Crystal resources/actions)
      "avici.crystal.create" -> avici_crystal(:create, msg)
      "avici.crystal.refine" -> avici_crystal(:refine, msg)
      "avici.crystal.search" -> avici_crystal(:search, msg)
      "avici.crystal.by_type" -> avici_crystal(:by_type, msg)
      "avici.crystal.by_source_conversation" -> avici_crystal(:by_source_conversation, msg)
      "avici.crystal.apply" -> avici_crystal(:apply, msg)
      # ==== MCP Broker (Avici-configurable; stubs) ===========================
      "avici.mcp.register" -> avici_mcp(:register, msg)
      "avici.mcp.connect" -> avici_mcp(:connect, msg)
      "avici.mcp.list" -> avici_mcp(:list, msg)
      "avici.mcp.status" -> avici_mcp(:status, msg)
      "avici.mcp.forward" -> avici_mcp(:forward, msg)
      "avici.mcp.disconnect" -> avici_mcp(:disconnect, msg)
      # ==== Generative & Media (stubs) ======================================
      "lang.text.generate" -> gen_text(:generate, msg)
      "lang.text.summarize" -> gen_text(:summarize, msg)
      "lang.text.translate" -> gen_text(:translate, msg)
      ...
      "lang.media.caption_video" -> gen_media(:caption_video, msg)
      "lang.media.mix_tracks" -> gen_media(:mix_tracks, msg)
      # Filesystem operations (routed via DomainRouter)
      "lang.fs.scan" -> Lang.LSP.DomainRouter.handle(msg)
      "lang.fs.search" -> Lang.LSP.DomainRouter.handle(msg)
      "lang.fs.search_code" -> Lang.LSP.DomainRouter.handle(msg)
      "lang.fs.preview" -> Lang.LSP.DomainRouter.handle(msg)
      ...
      # Parser operations (migrated):
      "lang.parser.parse" -> Lang.LSP.DomainRouter.handle(msg)
      # TODO: batch/stream may migrate later
      "lang.parser.parse_batch" -> parser_parse_batch(msg)
      "lang.parser.parse_stream" -> parser_parse_stream(msg)
      "lang.parser.detect_format" -> Lang.LSP.DomainRouter.handle(msg)
      # Graph operations
  ...
  # --------------------------------------------------------------------------
  # Generative/Media stubs (expand with providers later)
  # --------------------------------------------------------------------------
  defp gen_text(op, %{"id" => id, "params" => params}) do
    preview = param_preview(params)
    wrap_result(id, {:ok, %{status: "stub", domain: "text", op: op, accepted: true, params: preview}})
  end

  defp gen_image(op, %{"id" => id, "params" => params}) do
    preview = param_preview(params)
    wrap_result(id, {:ok, %{status: "stub", domain: "image", op: op, accepted: true, params: preview}})
  end

  defp gen_audio(op, %{"id" => id, "params" => params}) do
    preview = param_preview(params)
    wrap_result(id, {:ok, %{status: "stub", domain: "audio", op: op, accepted: true, params: preview}})
  end

  defp gen_video(op, %{"id" => id, "params" => params}) do
    preview = param_preview(params)
    wrap_result(id, {:ok, %{status: "stub", domain: "video", op: op, accepted: true, params: preview}})
  end

  defp gen_media(op, %{"id" => id, "params" => params}) do
    preview = param_preview(params)
    wrap_result(id, {:ok, %{status: "stub", domain: "media", op: op, accepted: true, params: preview}})
  end

  defp param_preview(%{} = params) do
    keys = params |> Map.keys() |> Enum.take(8)
  ...
  # --------------------------------------------------------------------------
  # Generative/Media & Avici stubs (implement providers later)
  # --------------------------------------------------------------------------
  defp gen_text(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("text", op, params)})
  end
  defp gen_image(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("image", op, params)})
  end
  defp gen_audio(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("audio", op, params)})
  end
  defp gen_video(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("video", op, params)})
  end
  defp gen_media(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("media", op, params)})
  end

  defp avici_conv(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.conversation", op, params)})
  end
  defp avici_knowledge(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.knowledge", op, params)})
  end
  defp avici_search(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.search", op, params)})
  end
  defp avici_pipeline(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.pipeline", op, params)})
  end
  defp avici_frame(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.frame", op, params)})
  end

  defp avici_services(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.services", op, params)})
  end

  defp avici_harvest(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.harvest", op, params)})
  end

  defp avici_patterns(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.patterns", op, params)})
  end

  defp avici_decisions(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.decisions", op, params)})
  end


  defp avici_crystal(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.crystal", op, params)})
  end

  defp avici_mcp(op, %{"id" => id, "params" => params}) do
    wrap_result(id, {:ok, stub_payload("avici.mcp", op, params)})
  end

  defp stub_payload(domain, op, %{} = params) do
    preview = params |> Map.take(Enum.take(Map.keys(params), 8))
    %{
      status: "stub",
      domain: domain,
      op: op,
