defmodule Lang.MCP.Connection do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :auth_session_id, :string do
      allow_nil?(true)

      description(
        "Authentication session id associated with this connection (ash_authentication)"
      )
    end
  ...
  relationships do
    belongs_to :server_config, Lang.MCP.ServerConfig do
    ...
    has_many :requests, Lang.MCP.Request do
  ...
  actions do
    ...
    create :create do
      ...
      # Optional: emit events or usage here if desired
    end
