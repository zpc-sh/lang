defmodule Lang.MCP.ServerConfig do
  @moduledoc """
  ...
  relationships do
    ...
    has_many :connections, Lang.MCP.Connection do
  ...
  actions do
    ...
    create :create do
      ...
      change(
        set_attribute(:metadata, &Lang.MCP.ServerConfig.Validations.build_json_ld_metadata/1)
      )
    end
    ...
    update :update do
      ...
      change(
        set_attribute(:metadata, &Lang.MCP.ServerConfig.Validations.update_json_ld_metadata/1)
      )
    end
